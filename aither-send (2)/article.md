...
![Архитектура платформы Aither](./architecture.svg)
...
![Путь запроса от пользователя до модели](./request-flow.svg)
...
![Стек проброса GPU: от драйвера до контейнера](./gpu-stack.svg)
...
![Схема деплоймента vLLM в K8s](./deployment.svg)
...
![Схема Tensor Parallelism: распределение модели на две GPU](./tensor-parallelism.svg)
