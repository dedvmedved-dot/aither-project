#!/bin/bash
# rb-aither-k2-08-vm-stress-n7 — n7 VM stress
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k2-08-vm-stress-n7.log"
...
log "=== START rb-aither-k2-08-vm-stress-n7 ==="
log "Description: n7 VM stress"
...
# Инжекция
log "Injecting fault..."
ssh n7 'stress-ng --vm 4 --vm-bytes 2G --timeout 180s &'
...
log "=== END rb-aither-k2-08-vm-stress-n7 ==="
