#!/bin/bash
# rb-aither-k7-03-iptables-redis — Block Redis port
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k7-03-iptables-redis.log"
...
log "=== START rb-aither-k7-03-iptables-redis ==="
log "Description: Block Redis port"
...
# Инжекция
log "Injecting fault..."
ssh n8 'iptables -A INPUT -p tcp --dport 6379 -j DROP'
...
# Восстановление
log "Recovering..."
ssh n8 'iptables -D INPUT -p tcp --dport 6379 -j DROP'
...
log "=== END rb-aither-k7-03-iptables-redis ==="
