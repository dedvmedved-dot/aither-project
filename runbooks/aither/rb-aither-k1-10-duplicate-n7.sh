#!/bin/bash
# rb-aither-k1-10-duplicate-n7 — n7 packet duplicate 10%
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k1-10-duplicate-n7.log"
...
log "=== START rb-aither-k1-10-duplicate-n7 ==="
log "Description: n7 packet duplicate 10%"
...
# Инжекция
log "Injecting fault..."
ssh n7 'tc qdisc add dev ens1f0 root netem duplicate 10%'
...
log "=== END rb-aither-k1-10-duplicate-n7 ==="
