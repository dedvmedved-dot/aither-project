#!/bin/bash
# rb-aither-k8-01-gpu-ecc — GPU ECC error injection
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k8-01-gpu-ecc.log"
...
log "=== START rb-aither-k8-01-gpu-ecc ==="
log "Description: GPU ECC error injection"
...
# Инжекция
log "Injecting fault..."
ssh n7 'nvidia-smi -e 1 2>/dev/null || echo ECC-already-enabled'
...
# Восстановление
log "Recovering..."
ssh n7 'nvidia-smi -e 0 2>/dev/null || echo ECC-reset'
...
log "=== END rb-aither-k8-01-gpu-ecc ==="
