#!/bin/bash
# rb-aither-k2-04-gpu-compute-n7 — n7 GPU compute stress
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k2-04-gpu-compute-n7.log"
...
log "=== START rb-aither-k2-04-gpu-compute-n7 ==="
log "Description: n7 GPU compute stress"
...
# Инжекция
log "Injecting fault..."
ssh n7 'python3 -c "import torch; a=torch.randn(4096,4096,device=\"cuda:0\"); [a@a for _ in range(200)]" &'
...
log "=== END rb-aither-k2-04-gpu-compute-n7 ==="
