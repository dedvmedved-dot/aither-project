#!/bin/bash
# rb-aither-k1-08-drop-vps2 — iptables DROP n8→VPS2
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k1-08-drop-vps2.log"
...
log "=== START rb-aither-k1-08-drop-vps2 ==="
log "Description: iptables DROP n8→VPS2"
...
# Инжекция
log "Injecting fault..."
ssh n8 'iptables -A OUTPUT -d 170.168.91.95 -j DROP'
...
# Восстановление
log "Recovering..."
ssh n8 'iptables -D OUTPUT -d 170.168.91.95 -j DROP'
...
log "=== END rb-aither-k1-08-drop-vps2 ==="
