#!/bin/bash
# rb-aither-k1-05-jitter-n7n8 — n7→n8 jitter 50ms
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k1-05-jitter-n7n8.log"
...
log "=== START rb-aither-k1-05-jitter-n7n8 ==="
log "Description: n7→n8 jitter 50ms"
...
# Инжекция
log "Injecting fault..."
ssh n7 'tc qdisc add dev ens1f0 root netem delay 50ms 50ms 25%'
...
log "=== END rb-aither-k1-05-jitter-n7n8 ==="
