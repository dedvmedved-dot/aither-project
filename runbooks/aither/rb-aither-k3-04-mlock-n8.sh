#!/bin/bash
# rb-aither-k3-04-mlock-n8 — n8 memory lock
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k3-04-mlock-n8.log"
...
log "=== START rb-aither-k3-04-mlock-n8 ==="
log "Description: n8 memory lock"
...
# Инжекция
log "Injecting fault..."
ssh n8 'stress-ng --mlock 2 --timeout 120s &'
...
# Восстановление
log "Recovering..."
ssh n8 'pkill -f stress-ng.*mlock'
...
log "=== END rb-aither-k3-04-mlock-n8 ==="
