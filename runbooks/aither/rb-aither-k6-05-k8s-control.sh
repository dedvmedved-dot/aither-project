#!/bin/bash
# rb-aither-k6-05-k8s-control — K8s control plane failure
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k6-05-k8s-control.log"
...
log "=== START rb-aither-k6-05-k8s-control ==="
log "Description: K8s control plane failure"
...
# Восстановление
log "Recovering..."
ssh n8 'systemctl start kubelet'
...
log "=== END rb-aither-k6-05-k8s-control ==="
