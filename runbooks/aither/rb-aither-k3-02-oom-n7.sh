#!/bin/bash
# rb-aither-k3-02-oom-n7 — n7 OOM killer
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k3-02-oom-n7.log"
...
log "=== START rb-aither-k3-02-oom-n7 ==="
log "Description: n7 OOM killer"
...
# Инжекция
log "Injecting fault..."
ssh n7 'stress-ng --vm 8 --vm-bytes 95% --timeout 60s &'
...
log "=== END rb-aither-k3-02-oom-n7 ==="
