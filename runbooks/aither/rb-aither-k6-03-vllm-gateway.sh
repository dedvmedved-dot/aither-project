#!/bin/bash
# rb-aither-k6-03-vllm-gateway — vLLM + Gateway cascade
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k6-03-vllm-gateway.log"
...
log "=== START rb-aither-k6-03-vllm-gateway ==="
log "Description: vLLM + Gateway cascade"
...
# Инжекция
log "Injecting fault..."
ssh n7 'systemctl stop vllm-32b'; ssh n8 'systemctl stop aither-gateway'
...
# Восстановление
log "Recovering..."
ssh n7 'systemctl start vllm-32b'; ssh n8 'systemctl start aither-gateway'
...
log "=== END rb-aither-k6-03-vllm-gateway ==="
