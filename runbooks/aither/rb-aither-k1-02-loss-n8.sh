#!/bin/bash
# rb-aither-k1-02-loss-n8 — n8 packet loss 15%
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k1-02-loss-n8.log"
...
log "=== START rb-aither-k1-02-loss-n8 ==="
log "Description: n8 packet loss 15%"
...
# Инжекция
log "Injecting fault..."
ssh n8 'tc qdisc add dev ens1f0 root netem loss 15%'
...
log "=== END rb-aither-k1-02-loss-n8 ==="
