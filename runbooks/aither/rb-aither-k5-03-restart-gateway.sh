#!/bin/bash
# rb-aither-k5-03-restart-gateway — Gateway restart
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k5-03-restart-gateway.log"
...
log "=== START rb-aither-k5-03-restart-gateway ==="
log "Description: Gateway restart"
...
# Инжекция
log "Injecting fault..."
ssh n8 'systemctl restart aither-gateway'
...
# Восстановление
log "Recovering..."
ssh n8 'systemctl start aither-gateway'
...
log "=== END rb-aither-k5-03-restart-gateway ==="
