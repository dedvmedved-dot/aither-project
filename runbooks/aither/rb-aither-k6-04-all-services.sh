#!/bin/bash
# rb-aither-k6-04-all-services — All services stop
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k6-04-all-services.log"
...
log "=== START rb-aither-k6-04-all-services ==="
log "Description: All services stop"
...
# Инжекция
log "Injecting fault..."
ssh n8 'systemctl stop postgresql redis aither-gateway'; ssh n7 'systemctl stop vllm-32b'
...
# Восстановление
log "Recovering..."
ssh n7 'systemctl start vllm-32b'; ssh n8 'systemctl start postgresql redis aither-gateway'
...
log "=== END rb-aither-k6-04-all-services ==="
