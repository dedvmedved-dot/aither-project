#!/bin/bash
# rb-aither-k4-05-disk-full-n8 — n8 disk full (dd)
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k4-05-disk-full-n8.log"
...
log "=== START rb-aither-k4-05-disk-full-n8 ==="
log "Description: n8 disk full (dd)"
...
# Инжекция
log "Injecting fault..."
ssh n8 'dd if=/dev/zero of=/tmp/fill bs=1M count=2000 2>/dev/null'
...
log "=== END rb-aither-k4-05-disk-full-n8 ==="
