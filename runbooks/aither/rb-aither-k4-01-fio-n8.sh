#!/bin/bash
# rb-aither-k4-01-fio-n8 — n8 fio random write
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k4-01-fio-n8.log"
...
log "=== START rb-aither-k4-01-fio-n8 ==="
log "Description: n8 fio random write"
...
# Инжекция
log "Injecting fault..."
ssh n8 'fio --name=rw --ioengine=libaio --iodepth=16 --rw=randwrite --bs=4k --size=2G --time_based --runtime=120 --filename=/tmp/fio-test &'
...
# Восстановление
log "Recovering..."
rm -f /tmp/fio-test ; ssh n8 'rm -f /tmp/fio-test'
...
log "=== END rb-aither-k4-01-fio-n8 ==="
