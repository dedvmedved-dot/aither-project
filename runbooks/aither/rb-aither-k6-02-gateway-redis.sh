#!/bin/bash
# rb-aither-k6-02-gateway-redis — Gateway + Redis failure
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k6-02-gateway-redis.log"
...
log "=== START rb-aither-k6-02-gateway-redis ==="
log "Description: Gateway + Redis failure"
...
# Инжекция
log "Injecting fault..."
ssh n8 'systemctl stop redis; sleep 2; systemctl stop aither-gateway'
...
# Восстановление
log "Recovering..."
ssh n8 'systemctl start redis; sleep 2; systemctl start aither-gateway'
...
log "=== END rb-aither-k6-02-gateway-redis ==="
