#!/bin/bash
# rb-aither-k2-03-gpu-mem-n7 — n7 GPU memory exhaustion
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k2-03-gpu-mem-n7.log"
...
log "=== START rb-aither-k2-03-gpu-mem-n7 ==="
log "Description: n7 GPU memory exhaustion"
...
# Инжекция
log "Injecting fault..."
ssh n7 'python3 -c "import torch; [torch.zeros(512,512,512,dtype=torch.float16,device=\"cuda:0\") for _ in range(4)]; import time; time.sleep(120)" &'
...
log "=== END rb-aither-k2-03-gpu-mem-n7 ==="
