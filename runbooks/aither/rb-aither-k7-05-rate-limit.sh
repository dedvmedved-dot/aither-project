#!/bin/bash
# rb-aither-k7-05-rate-limit — Rate limit spike (100 req/s)
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k7-05-rate-limit.log"
...
log "=== START rb-aither-k7-05-rate-limit ==="
log "Description: Rate limit spike (100 req/s)"
...
# Инжекция
log "Injecting fault..."
for i in $(seq 1 100); do curl -s -o /dev/null http://localhost:8080/health & done
...
log "=== END rb-aither-k7-05-rate-limit ==="
