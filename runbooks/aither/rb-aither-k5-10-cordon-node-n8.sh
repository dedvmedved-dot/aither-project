#!/bin/bash
# rb-aither-k5-10-cordon-node-n8 — K8s cordon n8
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k5-10-cordon-node-n8.log"
...
log "=== START rb-aither-k5-10-cordon-node-n8 ==="
log "Description: K8s cordon n8"
...
# Инжекция
log "Injecting fault..."
ssh n8 'kubectl cordon bootsman-k8s-clnt01-n8-gpu'
...
# Восстановление
log "Recovering..."
ssh n8 'kubectl uncordon bootsman-k8s-clnt01-n8-gpu'
...
log "=== END rb-aither-k5-10-cordon-node-n8 ==="
