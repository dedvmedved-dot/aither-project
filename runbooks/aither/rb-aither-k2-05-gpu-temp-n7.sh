#!/bin/bash
# rb-aither-k2-05-gpu-temp-n7 — n7 GPU thermal throttle
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k2-05-gpu-temp-n7.log"
...
log "=== START rb-aither-k2-05-gpu-temp-n7 ==="
log "Description: n7 GPU thermal throttle"
...
# Инжекция
log "Injecting fault..."
ssh n7 'nvidia-smi -pm 1; nvidia-smi -pl 100'
...
log "=== END rb-aither-k2-05-gpu-temp-n7 ==="
