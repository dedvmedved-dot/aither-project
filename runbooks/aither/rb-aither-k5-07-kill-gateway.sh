#!/bin/bash
# rb-aither-k5-07-kill-gateway — kill -9 Gateway
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k5-07-kill-gateway.log"
...
log "=== START rb-aither-k5-07-kill-gateway ==="
log "Description: kill -9 Gateway"
...
# Инжекция
log "Injecting fault..."
ssh n8 'kill -9 $(pgrep -f gateway.py)'
...
log "=== END rb-aither-k5-07-kill-gateway ==="
