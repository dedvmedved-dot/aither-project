#!/bin/bash
# rb-aither-k4-03-ro-fs-n8 — n8 read-only FS
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k4-03-ro-fs-n8.log"
...
log "=== START rb-aither-k4-03-ro-fs-n8 ==="
log "Description: n8 read-only FS"
...
# Инжекция
log "Injecting fault..."
ssh n8 'mount -o remount,ro /tmp 2>/dev/null || true'
...
# Восстановление
log "Recovering..."
ssh n8 'mount -o remount,rw /tmp 2>/dev/null || true'
...
log "=== END rb-aither-k4-03-ro-fs-n8 ==="
