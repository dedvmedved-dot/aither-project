#!/bin/bash
# rb-aither-k4-02-inodes-n8 — n8 inode exhaustion
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k4-02-inodes-n8.log"
...
log "=== START rb-aither-k4-02-inodes-n8 ==="
log "Description: n8 inode exhaustion"
...
# Инжекция
log "Injecting fault..."
ssh n8 'for i in $(seq 1 50000); do touch /tmp/inodes/$i 2>/dev/null; done'
...
log "=== END rb-aither-k4-02-inodes-n8 ==="
