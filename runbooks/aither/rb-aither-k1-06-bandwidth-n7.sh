#!/bin/bash
# rb-aither-k1-06-bandwidth-n7 — n7 bandwidth 1Mbps
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k1-06-bandwidth-n7.log"
...
log "=== START rb-aither-k1-06-bandwidth-n7 ==="
log "Description: n7 bandwidth 1Mbps"
...
# Инжекция
log "Injecting fault..."
ssh n7 'tc qdisc add dev ens1f0 root tbf rate 1mbit burst 32kbit latency 400ms'
...
# Восстановление
log "Recovering..."
ssh n7 'tc qdisc del dev ens1f0 root'
...
log "=== END rb-aither-k1-06-bandwidth-n7 ==="
