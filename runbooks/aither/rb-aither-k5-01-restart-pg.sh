#!/bin/bash
# rb-aither-k5-01-restart-pg — PostgreSQL restart
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k5-01-restart-pg.log"
...
log "=== START rb-aither-k5-01-restart-pg ==="
log "Description: PostgreSQL restart"
...
# Инжекция
log "Injecting fault..."
ssh n8 'systemctl stop postgresql'
...
# Восстановление
log "Recovering..."
ssh n8 'systemctl start postgresql'
...
log "=== END rb-aither-k5-01-restart-pg ==="
