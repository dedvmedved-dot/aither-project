#!/bin/bash
# rb-aither-k1-03-delay-n7 — n7 latency 200ms
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k1-03-delay-n7.log"
...
log "=== START rb-aither-k1-03-delay-n7 ==="
log "Description: n7 latency 200ms"
...
# Инжекция
log "Injecting fault..."
ssh n7 'tc qdisc add dev ens1f0 root netem delay 200ms 50ms'
...
log "=== END rb-aither-k1-03-delay-n7 ==="
