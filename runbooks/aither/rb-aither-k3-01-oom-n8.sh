#!/bin/bash
# rb-aither-k3-01-oom-n8 — n8 OOM killer
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k3-01-oom-n8.log"
...
log "=== START rb-aither-k3-01-oom-n8 ==="
log "Description: n8 OOM killer"
...
# Инжекция
log "Injecting fault..."
ssh n8 'stress-ng --vm 4 --vm-bytes 95% --timeout 60s &'
...
log "=== END rb-aither-k3-01-oom-n8 ==="
