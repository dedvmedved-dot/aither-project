#!/bin/bash
# rb-aither-k3-05-brk-n7 — n7 brk() exhaustion
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k3-05-brk-n7.log"
...
log "=== START rb-aither-k3-05-brk-n7 ==="
log "Description: n7 brk() exhaustion"
...
# Инжекция
log "Injecting fault..."
ssh n7 'stress-ng --brk 4 --timeout 120s &'
...
log "=== END rb-aither-k3-05-brk-n7 ==="
