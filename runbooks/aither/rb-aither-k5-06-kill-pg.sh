#!/bin/bash
# rb-aither-k5-06-kill-pg — kill -9 PostgreSQL
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k5-06-kill-pg.log"
...
log "=== START rb-aither-k5-06-kill-pg ==="
log "Description: kill -9 PostgreSQL"
...
# Инжекция
log "Injecting fault..."
ssh n8 'kill -9 $(pgrep -f postgres)'
...
log "=== END rb-aither-k5-06-kill-pg ==="
