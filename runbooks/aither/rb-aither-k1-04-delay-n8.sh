#!/bin/bash
# rb-aither-k1-04-delay-n8 — n8 latency 500ms
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k1-04-delay-n8.log"
...
log "=== START rb-aither-k1-04-delay-n8 ==="
log "Description: n8 latency 500ms"
...
# Инжекция
log "Injecting fault..."
ssh n8 'tc qdisc add dev ens1f0 root netem delay 500ms 100ms'
...
# Восстановление
log "Recovering..."
ssh n8 'tc qdisc del dev ens1f0 root'
...
log "=== END rb-aither-k1-04-delay-n8 ==="
