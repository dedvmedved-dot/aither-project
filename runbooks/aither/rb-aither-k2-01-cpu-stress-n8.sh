#!/bin/bash
# rb-aither-k2-01-cpu-stress-n8 — n8 CPU stress 4 ядра
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k2-01-cpu-stress-n8.log"
...
log "=== START rb-aither-k2-01-cpu-stress-n8 ==="
log "Description: n8 CPU stress 4 ядра"
...
# Инжекция
log "Injecting fault..."
ssh n8 'stress-ng --cpu 4 --timeout 180s &'
...
log "=== END rb-aither-k2-01-cpu-stress-n8 ==="
