#!/bin/bash
# rb-aither-k5-08-kill-vllm — kill -9 vLLM
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k5-08-kill-vllm.log"
...
log "=== START rb-aither-k5-08-kill-vllm ==="
log "Description: kill -9 vLLM"
...
log "=== END rb-aither-k5-08-kill-vllm ==="
