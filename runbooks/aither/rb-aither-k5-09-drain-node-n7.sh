#!/bin/bash
# rb-aither-k5-09-drain-node-n7 — K8s drain n7
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k5-09-drain-node-n7.log"
...
log "=== START rb-aither-k5-09-drain-node-n7 ==="
log "Description: K8s drain n7"
...
# Инжекция
log "Injecting fault..."
ssh n8 'kubectl drain bootsman-k8s-clnt01-n7-gpu --ignore-daemonsets --delete-emptydir-data'
...
# Восстановление
log "Recovering..."
ssh n8 'kubectl uncordon bootsman-k8s-clnt01-n7-gpu'
...
log "=== END rb-aither-k5-09-drain-node-n7 ==="
