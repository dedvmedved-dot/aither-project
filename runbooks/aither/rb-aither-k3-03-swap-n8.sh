#!/bin/bash
# rb-aither-k3-03-swap-n8 — n8 swap exhaustion
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k3-03-swap-n8.log"
...
log "=== START rb-aither-k3-03-swap-n8 ==="
log "Description: n8 swap exhaustion"
...
# Инжекция
log "Injecting fault..."
ssh n8 'stress-ng --vm 2 --vm-bytes 110% --timeout 60s &'
...
log "=== END rb-aither-k3-03-swap-n8 ==="
