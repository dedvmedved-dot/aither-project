#!/bin/bash
# rb-aither-k2-02-cpu-stress-n7 — n7 CPU stress 8 ядер
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k2-02-cpu-stress-n7.log"
...
log "=== START rb-aither-k2-02-cpu-stress-n7 ==="
log "Description: n7 CPU stress 8 ядер"
...
# Инжекция
log "Injecting fault..."
ssh n7 'stress-ng --cpu 8 --timeout 180s &'
...
log "=== END rb-aither-k2-02-cpu-stress-n7 ==="
