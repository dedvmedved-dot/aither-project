#!/bin/bash
# rb-aither-k5-05-restart-vllm14b — vLLM 14B pod restart
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-aither-k5-05-restart-vllm14b.log"
...
log "=== START rb-aither-k5-05-restart-vllm14b ==="
log "Description: vLLM 14B pod restart"
...
# Инжекция
log "Injecting fault..."
ssh n8 'kubectl delete pod -l app=vllm-14b'
...
# Восстановление
log "Recovering..."
ssh n8 'kubectl wait --for=condition=ready pod -l app=vllm-14b --timeout=300s'
...
log "=== END rb-aither-k5-05-restart-vllm14b ==="
