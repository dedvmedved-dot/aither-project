#!/bin/bash
# rb-brest-k4-05-drbd-split-brain — DRBD split-brain
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k4-05-drbd-split-brain.log"
...
log "=== START rb-brest-k4-05-drbd-split-brain ==="
log "Description: DRBD split-brain"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'drbdadm secondary r0'
...
# Восстановление
log "Recovering..."
ssh brest-node 'drbdadm primary r0'
...
log "=== END rb-brest-k4-05-drbd-split-brain ==="
