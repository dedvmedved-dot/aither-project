#!/bin/bash
# rb-brest-k3-01-oom — Брест OOM killer
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k3-01-oom.log"
...
log "=== START rb-brest-k3-01-oom ==="
log "Description: Брест OOM killer"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'stress-ng --vm 4 --vm-bytes 95% --timeout 60s &'
