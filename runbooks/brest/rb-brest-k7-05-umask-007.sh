#!/bin/bash
# rb-brest-k7-05-umask-007 — UMASK 0077
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k7-05-umask-007.log"
...
log "=== START rb-brest-k7-05-umask-007 ==="
log "Description: UMASK 0077"
...
# Инжекция
log "Injecting fault..."
echo 'umask 0077' > /tmp/umask-test
...
log "=== END rb-brest-k7-05-umask-007 ==="
