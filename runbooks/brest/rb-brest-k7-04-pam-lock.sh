#!/bin/bash
# rb-brest-k7-04-pam-lock — PAM lockout
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k7-04-pam-lock.log"
...
log "=== START rb-brest-k7-04-pam-lock ==="
log "Description: PAM lockout"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'pam_tally2 --user test --reset 2>/dev/null || true'
...
log "=== END rb-brest-k7-04-pam-lock ==="
