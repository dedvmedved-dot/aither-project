#!/bin/bash
# rb-brest-k4-08-fio-rbd — RBD fio stress
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k4-08-fio-rbd.log"
...
log "=== START rb-brest-k4-08-fio-rbd ==="
log "Description: RBD fio stress"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'fio --name=test --ioengine=rbd --pool=rbd --rbdname=test --rw=randwrite --bs=4k --runtime=60 &'
...
log "=== END rb-brest-k4-08-fio-rbd ==="
