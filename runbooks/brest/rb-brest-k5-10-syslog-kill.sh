#!/bin/bash
# rb-brest-k5-10-syslog-kill — Syslog kill
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k5-10-syslog-kill.log"
...
log "=== START rb-brest-k5-10-syslog-kill ==="
log "Description: Syslog kill"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'kill -9 $(pgrep rsyslogd)'
...
# Восстановление
log "Recovering..."
ssh brest-node 'systemctl start rsyslog'
...
log "=== END rb-brest-k5-10-syslog-kill ==="
