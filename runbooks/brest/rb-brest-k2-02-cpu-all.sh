#!/bin/bash
# rb-brest-k2-02-cpu-all — Брест CPU 16 ядер
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k2-02-cpu-all.log"
...
log "=== START rb-brest-k2-02-cpu-all ==="
log "Description: Брест CPU 16 ядер"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'stress-ng --cpu 16 --timeout 180s &'
...
# Восстановление
log "Recovering..."
ssh brest-node 'pkill -f stress-ng'
...
log "=== END rb-brest-k2-02-cpu-all ==="
