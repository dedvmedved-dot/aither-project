#!/bin/bash
# rb-brest-k1-01-loss — Брест loss 10%
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k1-01-loss.log"
...
log "=== START rb-brest-k1-01-loss ==="
log "Description: Брест loss 10%"
...
# Инжекция
log "Injecting fault..."
ssh brest-gw 'tc qdisc add dev eth0 root netem loss 10%'
