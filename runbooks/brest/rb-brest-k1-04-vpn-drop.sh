#!/bin/bash
# rb-brest-k1-04-vpn-drop — VPN Cisco DROP
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k1-04-vpn-drop.log"
...
log "=== START rb-brest-k1-04-vpn-drop ==="
log "Description: VPN Cisco DROP"
...
# Инжекция
log "Injecting fault..."
ssh brest-gw 'iptables -A INPUT -i tun0 -j DROP'
...
# Восстановление
log "Recovering..."
ssh brest-gw 'iptables -D INPUT -i tun0 -j DROP'
...
log "=== END rb-brest-k1-04-vpn-drop ==="
