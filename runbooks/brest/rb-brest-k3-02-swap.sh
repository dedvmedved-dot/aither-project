#!/bin/bash
# rb-brest-k3-02-swap — Брест swap exhaustion
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k3-02-swap.log"
...
log "=== START rb-brest-k3-02-swap ==="
log "Description: Брест swap exhaustion"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'stress-ng --vm 2 --vm-bytes 110% --timeout 60s &'
...
# Восстановление
log "Recovering..."
ssh brest-node 'pkill -f stress-ng.*vm'
