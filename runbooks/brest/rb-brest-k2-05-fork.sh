#!/bin/bash
# rb-brest-k2-05-fork — Брест fork bomb
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k2-05-fork.log"
...
log "=== START rb-brest-k2-05-fork ==="
log "Description: Брест fork bomb"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'stress-ng --fork 100 --timeout 30s &'
...
# Восстановление
log "Recovering..."
ssh brest-node 'pkill -f stress-ng.*fork'
