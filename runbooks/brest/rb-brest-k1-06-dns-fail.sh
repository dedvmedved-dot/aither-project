#!/bin/bash
# rb-brest-k1-06-dns-fail — DNS failure
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k1-06-dns-fail.log"
...
log "=== START rb-brest-k1-06-dns-fail ==="
log "Description: DNS failure"
...
# Инжекция
log "Injecting fault..."
cp /etc/resolv.conf /etc/resolv.conf.bak; echo > /etc/resolv.conf
...
log "=== END rb-brest-k1-06-dns-fail ==="
