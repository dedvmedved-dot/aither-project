#!/bin/bash
# rb-brest-k4-10-inode-ceph — Ceph FS inode exhaustion
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k4-10-inode-ceph.log"
...
log "=== START rb-brest-k4-10-inode-ceph ==="
log "Description: Ceph FS inode exhaustion"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'for i in $(seq 1 50000); do touch /mnt/cephfs/inodes/$i 2>/dev/null; done'
...
# Восстановление
log "Recovering..."
ssh brest-node 'rm -rf /mnt/cephfs/inodes/*'
...
log "=== END rb-brest-k4-10-inode-ceph ==="
