#!/bin/bash
# rb-brest-k4-04-drbd-disconnect — DRBD disconnect
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k4-04-drbd-disconnect.log"
...
log "=== START rb-brest-k4-04-drbd-disconnect ==="
log "Description: DRBD disconnect"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'drbdadm disconnect r0'
...
# Восстановление
log "Recovering..."
ssh brest-node 'drbdadm connect r0'
...
log "=== END rb-brest-k4-04-drbd-disconnect ==="
