#!/bin/bash
# rb-brest-k8-01-astra-lock — Astra Linux mandatory lock
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k8-01-astra-lock.log"
...
log "=== START rb-brest-k8-01-astra-lock ==="
log "Description: Astra Linux mandatory lock"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'astra-modeset 1 2>/dev/null || true'
...
# Восстановление
log "Recovering..."
ssh brest-node 'astra-modeset 0 2>/dev/null || true'
...
log "=== END rb-brest-k8-01-astra-lock ==="
