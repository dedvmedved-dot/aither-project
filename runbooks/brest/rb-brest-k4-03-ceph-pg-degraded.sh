#!/bin/bash
# rb-brest-k4-03-ceph-pg-degraded — Ceph PG degraded
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k4-03-ceph-pg-degraded.log"
...
log "=== START rb-brest-k4-03-ceph-pg-degraded ==="
log "Description: Ceph PG degraded"
...
log "=== END rb-brest-k4-03-ceph-pg-degraded ==="
