#!/bin/bash
# rb-brest-k5-06-chrony-stop — Chrony stop
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k5-06-chrony-stop.log"
...
log "=== START rb-brest-k5-06-chrony-stop ==="
log "Description: Chrony stop"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'systemctl stop chronyd'
...
# Восстановление
log "Recovering..."
ssh brest-node 'systemctl start chronyd'
...
log "=== END rb-brest-k5-06-chrony-stop ==="
