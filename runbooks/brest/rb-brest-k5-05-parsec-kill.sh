#!/bin/bash
# rb-brest-k5-05-parsec-kill — Parsec kill
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k5-05-parsec-kill.log"
...
log "=== START rb-brest-k5-05-parsec-kill ==="
log "Description: Parsec kill"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'kill -9 $(pgrep parsec)'
...
# Восстановление
log "Recovering..."
ssh brest-node 'systemctl start parsec'
...
log "=== END rb-brest-k5-05-parsec-kill ==="
