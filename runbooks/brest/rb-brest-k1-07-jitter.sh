#!/bin/bash
# rb-brest-k1-07-jitter — Брест jitter 100ms
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k1-07-jitter.log"
...
log "=== START rb-brest-k1-07-jitter ==="
log "Description: Брест jitter 100ms"
...
# Инжекция
log "Injecting fault..."
ssh brest-gw 'tc qdisc add dev eth0 root netem delay 50ms 100ms 50%'
