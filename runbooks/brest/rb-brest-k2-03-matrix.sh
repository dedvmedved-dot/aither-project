#!/bin/bash
# rb-brest-k2-03-matrix — Брест matrix stress
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k2-03-matrix.log"
...
log "=== START rb-brest-k2-03-matrix ==="
log "Description: Брест matrix stress"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'stress-ng --matrix 4 --timeout 180s &'
...
# Восстановление
log "Recovering..."
ssh brest-node 'pkill -f stress-ng.*matrix'
