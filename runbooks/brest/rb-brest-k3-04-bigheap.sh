#!/bin/bash
# rb-brest-k3-04-bigheap — Брест big heap
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k3-04-bigheap.log"
...
log "=== START rb-brest-k3-04-bigheap ==="
log "Description: Брест big heap"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'stress-ng --bigheap 2 --timeout 60s &'
...
# Восстановление
log "Recovering..."
ssh brest-node 'pkill -f stress-ng.*bigheap'
...
log "=== END rb-brest-k3-04-bigheap ==="
