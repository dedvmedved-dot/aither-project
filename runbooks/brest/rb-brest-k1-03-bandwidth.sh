#!/bin/bash
# rb-brest-k1-03-bandwidth — Брест bandwidth 2Mbps
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k1-03-bandwidth.log"
...
log "=== START rb-brest-k1-03-bandwidth ==="
log "Description: Брест bandwidth 2Mbps"
...
# Инжекция
log "Injecting fault..."
ssh brest-gw 'tc qdisc add dev eth0 root tbf rate 2mbit burst 32kbit latency 400ms'
...
log "=== END rb-brest-k1-03-bandwidth ==="
