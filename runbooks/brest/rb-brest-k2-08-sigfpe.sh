#!/bin/bash
# rb-brest-k2-08-sigfpe — Брест FP exception flood
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k2-08-sigfpe.log"
...
log "=== START rb-brest-k2-08-sigfpe ==="
log "Description: Брест FP exception flood"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'stress-ng --sigfpe 4 --timeout 60s &'
...
# Восстановление
log "Recovering..."
ssh brest-node 'pkill -f stress-ng.*sigfpe'
