#!/bin/bash
# rb-brest-k4-02-ceph-mon-down — Ceph MON down
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k4-02-ceph-mon-down.log"
...
log "=== START rb-brest-k4-02-ceph-mon-down ==="
log "Description: Ceph MON down"
...
# Инжекция
log "Injecting fault..."
ssh brest-ceph 'systemctl stop ceph-mon@brest'
...
# Восстановление
log "Recovering..."
ssh brest-ceph 'systemctl start ceph-mon@brest'
...
log "=== END rb-brest-k4-02-ceph-mon-down ==="
