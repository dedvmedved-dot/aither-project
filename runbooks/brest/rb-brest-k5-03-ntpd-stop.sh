#!/bin/bash
# rb-brest-k5-03-ntpd-stop — NTPd stop
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k5-03-ntpd-stop.log"
...
log "=== START rb-brest-k5-03-ntpd-stop ==="
log "Description: NTPd stop"
...
# Инжекция
log "Injecting fault..."
ssh brest-ntp 'systemctl stop ntpd'
...
# Восстановление
log "Recovering..."
ssh brest-ntp 'systemctl start ntpd'
...
log "=== END rb-brest-k5-03-ntpd-stop ==="
