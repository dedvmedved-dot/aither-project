#!/bin/bash
# rb-brest-k5-04-ssh-kill — SSHd kill
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k5-04-ssh-kill.log"
...
log "=== START rb-brest-k5-04-ssh-kill ==="
log "Description: SSHd kill"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'kill -9 $(pgrep sshd)'
...
# Восстановление
log "Recovering..."
ssh brest-node 'systemctl start sshd'
...
log "=== END rb-brest-k5-04-ssh-kill ==="
