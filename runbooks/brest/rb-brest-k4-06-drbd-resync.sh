#!/bin/bash
# rb-brest-k4-06-drbd-resync — DRBD resync trigger
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k4-06-drbd-resync.log"
...
log "=== START rb-brest-k4-06-drbd-resync ==="
log "Description: DRBD resync trigger"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'drbdadm invalidate r0'
...
log "=== END rb-brest-k4-06-drbd-resync ==="
