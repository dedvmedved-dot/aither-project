#!/bin/bash
# rb-brest-k7-01-parsec-block — Parsec mandatory block
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k7-01-parsec-block.log"
...
log "=== START rb-brest-k7-01-parsec-block ==="
log "Description: Parsec mandatory block"
...
log "=== END rb-brest-k7-01-parsec-block ==="
