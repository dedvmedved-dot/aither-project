#!/bin/bash
# rb-brest-k2-04-crypto — Брест crypto stress
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k2-04-crypto.log"
...
log "=== START rb-brest-k2-04-crypto ==="
log "Description: Брест crypto stress"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'stress-ng --crypt 4 --timeout 120s &'
...
# Восстановление
log "Recovering..."
ssh brest-node 'pkill -f stress-ng.*crypt'
