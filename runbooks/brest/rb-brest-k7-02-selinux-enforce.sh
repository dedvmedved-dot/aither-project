#!/bin/bash
# rb-brest-k7-02-selinux-enforce — SELinux enforce
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k7-02-selinux-enforce.log"
...
log "=== START rb-brest-k7-02-selinux-enforce ==="
log "Description: SELinux enforce"
...
log "=== END rb-brest-k7-02-selinux-enforce ==="
