#!/bin/bash
# rb-brest-k1-02-delay — Брест latency 300ms
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k1-02-delay.log"
...
log "=== START rb-brest-k1-02-delay ==="
log "Description: Брест latency 300ms"
...
# Инжекция
log "Injecting fault..."
ssh brest-gw 'tc qdisc add dev eth0 root netem delay 300ms 50ms'
