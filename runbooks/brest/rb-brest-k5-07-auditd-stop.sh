#!/bin/bash
# rb-brest-k5-07-auditd-stop — Auditd stop
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k5-07-auditd-stop.log"
...
log "=== START rb-brest-k5-07-auditd-stop ==="
log "Description: Auditd stop"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'systemctl stop auditd'
...
# Восстановление
log "Recovering..."
ssh brest-node 'systemctl start auditd'
...
log "=== END rb-brest-k5-07-auditd-stop ==="
