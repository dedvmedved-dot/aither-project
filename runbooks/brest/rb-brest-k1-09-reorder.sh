#!/bin/bash
# rb-brest-k1-09-reorder — Брест reorder 25%
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k1-09-reorder.log"
...
log "=== START rb-brest-k1-09-reorder ==="
log "Description: Брест reorder 25%"
...
# Инжекция
log "Injecting fault..."
ssh brest-gw 'tc qdisc add dev eth0 root netem delay 10ms reorder 25% 50%'
...
log "=== END rb-brest-k1-09-reorder ==="
