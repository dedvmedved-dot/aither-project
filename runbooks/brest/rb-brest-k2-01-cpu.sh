#!/bin/bash
# rb-brest-k2-01-cpu — Брест CPU 4 ядра
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k2-01-cpu.log"
...
log "=== START rb-brest-k2-01-cpu ==="
log "Description: Брест CPU 4 ядра"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'stress-ng --cpu 4 --timeout 180s &'
