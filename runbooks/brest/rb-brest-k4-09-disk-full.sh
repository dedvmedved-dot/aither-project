#!/bin/bash
# rb-brest-k4-09-disk-full — Ceph disk full
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k4-09-disk-full.log"
...
log "=== START rb-brest-k4-09-disk-full ==="
log "Description: Ceph disk full"
...
# Инжекция
log "Injecting fault..."
ssh brest-ceph 'dd if=/dev/zero of=/var/lib/ceph/osd/fill bs=1M count=5000 2>/dev/null'
...
# Восстановление
log "Recovering..."
ssh brest-ceph 'rm -f /var/lib/ceph/osd/fill'
...
log "=== END rb-brest-k4-09-disk-full ==="
