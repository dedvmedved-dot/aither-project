#!/bin/bash
# rb-brest-k8-02-mc-kill — MC kill
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k8-02-mc-kill.log"
...
log "=== START rb-brest-k8-02-mc-kill ==="
log "Description: MC kill"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'kill -9 $(pgrep mc)'
...
log "=== END rb-brest-k8-02-mc-kill ==="
