#!/bin/bash
# rb-brest-k5-09-crond-kill — Crond kill
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k5-09-crond-kill.log"
...
log "=== START rb-brest-k5-09-crond-kill ==="
log "Description: Crond kill"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'kill -9 $(pgrep crond)'
...
# Восстановление
log "Recovering..."
ssh brest-node 'systemctl start crond'
...
log "=== END rb-brest-k5-09-crond-kill ==="
