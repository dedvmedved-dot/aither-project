#!/bin/bash
# rb-brest-k5-08-firewalld-stop — Firewalld stop
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k5-08-firewalld-stop.log"
...
log "=== START rb-brest-k5-08-firewalld-stop ==="
log "Description: Firewalld stop"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'systemctl stop firewalld'
...
# Восстановление
log "Recovering..."
ssh brest-node 'systemctl start firewalld'
...
log "=== END rb-brest-k5-08-firewalld-stop ==="
