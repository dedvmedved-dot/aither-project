#!/bin/bash
# rb-brest-k4-07-ceph-io — Ceph I/O stress
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k4-07-ceph-io.log"
...
log "=== START rb-brest-k4-07-ceph-io ==="
log "Description: Ceph I/O stress"
...
# Инжекция
log "Injecting fault..."
ssh brest-ceph 'rados bench -p rbd 60 write &'
...
log "=== END rb-brest-k4-07-ceph-io ==="
