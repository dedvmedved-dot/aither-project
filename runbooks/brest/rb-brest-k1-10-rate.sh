#!/bin/bash
# rb-brest-k1-10-rate — Брест rate limit 5Mbps
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k1-10-rate.log"
...
log "=== START rb-brest-k1-10-rate ==="
log "Description: Брест rate limit 5Mbps"
...
# Инжекция
log "Injecting fault..."
ssh brest-gw 'tc qdisc add dev eth0 root tbf rate 5mbit burst 64kbit latency 200ms'
