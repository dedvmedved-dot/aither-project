#!/bin/bash
# rb-brest-k4-01-ceph-osd-down — Ceph OSD down
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k4-01-ceph-osd-down.log"
...
log "=== START rb-brest-k4-01-ceph-osd-down ==="
log "Description: Ceph OSD down"
...
# Инжекция
log "Injecting fault..."
ssh brest-ceph 'systemctl stop ceph-osd@0'
...
# Восстановление
log "Recovering..."
ssh brest-ceph 'systemctl start ceph-osd@0'
...
log "=== END rb-brest-k4-01-ceph-osd-down ==="
