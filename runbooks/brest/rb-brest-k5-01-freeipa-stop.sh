#!/bin/bash
# rb-brest-k5-01-freeipa-stop — FreeIPA stop
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k5-01-freeipa-stop.log"
...
log "=== START rb-brest-k5-01-freeipa-stop ==="
log "Description: FreeIPA stop"
...
# Инжекция
log "Injecting fault..."
ssh brest-ipa 'systemctl stop ipa'
...
# Восстановление
log "Recovering..."
ssh brest-ipa 'systemctl start ipa'
...
log "=== END rb-brest-k5-01-freeipa-stop ==="
