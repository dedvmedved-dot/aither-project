#!/bin/bash
# rb-brest-k3-05-shm — Брест shared memory
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k3-05-shm.log"
...
log "=== START rb-brest-k3-05-shm ==="
log "Description: Брест shared memory"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'stress-ng --shm 4 --timeout 120s &'
...
# Восстановление
log "Recovering..."
ssh brest-node 'pkill -f stress-ng.*shm'
