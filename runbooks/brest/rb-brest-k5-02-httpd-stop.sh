#!/bin/bash
# rb-brest-k5-02-httpd-stop — HTTPd stop
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k5-02-httpd-stop.log"
...
log "=== START rb-brest-k5-02-httpd-stop ==="
log "Description: HTTPd stop"
...
# Инжекция
log "Injecting fault..."
ssh brest-ipa 'systemctl stop httpd'
...
# Восстановление
log "Recovering..."
ssh brest-ipa 'systemctl start httpd'
...
log "=== END rb-brest-k5-02-httpd-stop ==="
