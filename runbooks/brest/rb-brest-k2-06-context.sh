#!/bin/bash
# rb-brest-k2-06-context — Брест context switch
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k2-06-context.log"
...
log "=== START rb-brest-k2-06-context ==="
log "Description: Брест context switch"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'stress-ng --context 8 --timeout 180s &'
...
# Восстановление
log "Recovering..."
ssh brest-node 'pkill -f stress-ng.*context'
...
log "=== END rb-brest-k2-06-context ==="
