#!/bin/bash
# rb-brest-k3-03-stack — Брест stack overflow
# Часть ПМИ AIOps — испытания Aither + ПК СВ Брест
# Сгенерирован: 2026-07-15 14:00:47 MSK

set -e
LOG="/opt/aiops-aither/logs/runbooks/rb-brest-k3-03-stack.log"
...
log "=== START rb-brest-k3-03-stack ==="
log "Description: Брест stack overflow"
...
# Инжекция
log "Injecting fault..."
ssh brest-node 'stress-ng --stack 4 --timeout 60s &'
...
# Восстановление
log "Recovering..."
ssh brest-node 'pkill -f stress-ng.*stack'
