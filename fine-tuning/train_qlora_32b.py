#!/usr/bin/env python3
"""
QLoRA (4-bit) fine-tuning для Qwen 2.5 32B на доменных знаниях РФ госсектора.
Использует 4-bit квантование, чтобы влезть в 2×23 GB VRAM.
"""
...
OUTPUT_DIR = "/mnt/models/lora-qwen32b-astra"
