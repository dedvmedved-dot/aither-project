...
| N-05 | Совместимость с браузерами | Chromium (headless) | ✅ | Протестировано в Chromium — полный E2E сценарий пройден |
...
CB-WEBUI-01 **принимается** без оговорок. Все 41 приёмочных критериев пройдены полностью.
