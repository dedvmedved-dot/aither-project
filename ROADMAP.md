...
| 21a | **Тарифные планы** (Free/Standard/VIP/Enterprise) | P1 | ⬜ | 3 дня |
...
| 4. RAG + кастомизация | 4 | 2 | 2 |
| 5. Продакшен-класс | 7 | 0 | 7 |
| 6. Эксплуатация | 6 | 0 | 6 |
| 7. Закрытый контур | 1 | 0 | 1 |
| **Итого** | **36** | **18** | **18** |

**Готовность:** 50% (18/36 — MVP + биллинг + каталог + Observability + Security + Gateway K8s + Портал + RAG + Cost-aware routing)
...
| 2 | **Проверка портала специалистами** | Фидбек от реальных пользователей |
| 3 | **RAG — индексация документов** | Внутренняя документация, техподдержка |
