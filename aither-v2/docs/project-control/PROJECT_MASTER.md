...
| Risk | Status |
|---|---|
| Gateway previously had ImagePullBackOff pods | Open until Stage 04 audit |
| Direct 32B vLLM access may bypass gateway policy | Accepted for MVP internal scope, must be controlled by BFF/Portal routing |
| TP=2 not tested | Accepted; postponed |
| Rate limiting not finalized | Target Stage 06 or later |
