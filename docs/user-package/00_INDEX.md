...
| Зона | URL | Доступ |
|---|---|---|
| **Internet** | `https://fb1.spb.ru:443/` | Открытый (HTTPS, доверенный сертификат Let's Encrypt) |
...
2. Откройте **[Web UI](https://fb1.spb.ru:443/)** — основной интерфейс
...
| 1.1 | 25.07.2026 | CB-WEBUI-01-R1: Web UI как основной интерфейс, новые документы 13–16, переход на `athr_`-ключи, сертификат Let's Encrypt |
