...
4. [GET /api/v1/models — Список моделей](#get-apiv1models--список-моделей)
5. [POST /api/v1/chat/completions — Чат и completion](#post-apiv1chatcompletions--чат-и-completion)
